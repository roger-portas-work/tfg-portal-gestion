<x-filament-widgets::widget>
    <section id="operaciones-confirmadas-vista" class="idrx-widget-card idrx-anchor">
        <div class="idrx-widget-header">
            <h2 class="idrx-widget-title">Operaciones confirmadas - {{ $operationWindow['label'] }}</h2>
            <p class="idrx-widget-description">
                {{ $operationWindow['description'] }}, incluyendo las que todavía no tienen trámites.
            </p>
        </div>
        ...
        <div class="idrx-card-grid">
            @forelse ($operaciones as $operacion)
                <a href="{{ $operacion['url'] }}" class="idrx-action-card idrx-card-{{ $operacion['tone'] }}">
                    ...
                    <div class="idrx-meta-grid">
                        ...
                        <div>
                            <div class="idrx-meta-label">Trámites</div>
            ...
            @empty
                <div class="idrx-empty">
                    No hay operaciones confirmadas en esta vista.
                </div>
            @endforelse
        </div>
    </section>
